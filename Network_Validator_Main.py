...
def main(network_name='.'):
    ...
    # 2. Test Specific Folder, pls enter your directory path in    r'your_path':
    subdirectories = get_all_directories(r'/Users/mustafagadah/Desktop/net_validator_code_I-17')
